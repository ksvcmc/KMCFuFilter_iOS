...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        [self addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(hudDidTapped:)]];
...
- (void)hudDidTapped:(UITapGestureRecognizer *)tapGes{
}
